...
# MA 02111-1307  USA
#
# $Id: runProxyTest.sh,v 1.2 2009/11/09 23:13:27 rhiriart Exp $
#
...
#declare TEST_CLASS=alma.scheduling.inttest.SchedulingTemplateTest
declare TEST_CLASS=alma.scheduling.inttest.StatusProxyTest
declare TEST_SUITE=""
