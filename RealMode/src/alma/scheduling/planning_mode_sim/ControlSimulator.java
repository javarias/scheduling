...
public class ControlSimulator extends BasicComponent implements Control {
	...
	public int createSubarray(int[] antenna) throws SchedulingException {
		Antenna x = null;
		for (int i = 0; i < antenna.length; ++i) {
	...
	public void destroySubarray(int subarrayId) throws SchedulingException {
	 ...
	 */
	public void execSB(int subarrayId, BestSB best, DateTime time)
	 ...
	 */
	public void execSB(int subarrayId, BestSB best) throws SchedulingException {
			// Get the subarray.
			Subarray s = getSubarray(subarrayId);
			if (s == null)
				error("Subarray " + subarrayId + " was not found.");
	 ...
	 */
	public int[] getActiveSubarray() throws SchedulingException {
		Subarray[] x = telescope.getSubarray();
	 ...
	 */
	public int[] getIdleAntennas() throws SchedulingException {
		Antenna[] x = telescope.getAntenna();
		int count = 0;
		for (int i = 0; i < x.length; ++i) {
			if (x[i].isIdle())
	 ...
	 */
	public int[] getSubarrayAntennas(int subarrayId)
		throws SchedulingException {
		// Get the subarray.
		Subarray s = getSubarray(subarrayId);
		if (s == null)
	 ...
	 */
	public void stopSB(int subarrayId, String id)
		throws SchedulingException {
