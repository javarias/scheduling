...
import alma.scheduling.planning_mode_sim.TelescopeSimulator;
import alma.scheduling.planning_mode_sim.OperatorSimulator;
...
import alma.scheduling.planning_mode_sim.Container;
import alma.scheduling.planning_mode_sim.ArchiveSimulator;
import alma.scheduling.planning_mode_sim.ControlSimulator;
import alma.scheduling.planning_mode_sim.ProjectManagerSimulator;
import alma.scheduling.planning_mode_sim.Reporter;
import alma.scheduling.planning_mode_sim.ClockSimulator;
...
public class MasterScheduler extends BasicComponent {
	...
	public void runSimulation() {
		...
		try {
			...
			// Create a subarray.
			int[] ant = control.getIdleAntennas();
			int subarrayId = control.createSubarray(ant);
			...
			SchedulerConfiguration config = new SchedulerConfiguration (
					...
					true,true,queue,5,0,subarrayId,clock,control,operator,telescope,
					projectManager,policy,logger);			
