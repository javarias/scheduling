...
import alma.scheduling.FullModeSimulatorPOATie;

import alma.scheduling.simulator.FullModeSimulatorImpl;
 ...
 * <p>
 * Name="FULLMODESIMULATOR1" Code="alma.schedulingsimulator.FullModeSimulatorImpl.FullModeSimulatorHelper" Type="IDL:alma/schedulingsimulator/FullModeSimulator:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class FullModeSimulatorHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public FullModeSimulatorHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new FullModeSimulatorImpl();
	}
	...
	*/
	...
	{
		return FullModeSimulatorPOATie.class;
	}
	...
	*/
	...
	{
		return FullModeSimulatorOperations.class;
	}
