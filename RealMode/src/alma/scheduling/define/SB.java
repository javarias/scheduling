...
public class SB implements ProgramMember {
	...
	// The total time required to execute this SUnit.
	private int totalRequiredTimeInSeconds;
	// The total amount of time used by this SUnit so far.
	 ...
	 * @param id The archive-id of the scheduling block that this SUnit represents.
	 */
	public SB(String id) {
		schedBlockId = id;
		project = null;
	...
	/**
	 * Set the time when this SUnit is ready.  At this point the total
	 * required time is also set.
	 * 
	 * @param time This time at which this SUnit is ready.
	 */
	 ...
	 * project level.
	 * 
	 * @param time The time at which this SUnit started.
	 */
