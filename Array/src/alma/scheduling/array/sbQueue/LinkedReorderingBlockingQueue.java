...
// Copied from java.util.concurrent.LinkedBlockingQueue with the
// only difference that the functions moveUp() and moveDown() have been added,
// allowing to reorder the contents of the queue.
 ...
 *
 */
public class LinkedReorderingBlockingQueue<E> extends AbstractQueue<E>
        implements ReorderingBlockingQueue<E>, java.io.Serializable {
     ...
     */
    public LinkedReorderingBlockingQueue() {
     ...
     *         than zero
     */
    public LinkedReorderingBlockingQueue(int capacity) {
     ...
     */
    public LinkedReorderingBlockingQueue(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        for (E e : c)
            add(e);
    }
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            final ReentrantLock putLock = LinkedReorderingBlockingQueue.this.putLock;
            final ReentrantLock takeLock = LinkedReorderingBlockingQueue.this.takeLock;
            putLock.lock();
            takeLock.lock();
            try {
                current = head.next;
