 ...
 *
 */
public class ControlAutomaticArrayImpl implements ControlArray {

    private final ContainerServices container;
    
    private final String arrayName;
    
    private final AutomaticArray array;
    
    public ControlAutomaticArrayImpl(ContainerServices container, String arrayName)
        throws AcsJContainerServicesEx, TranslationException {
        this.container = container;
        this.arrayName = arrayName;
        this.array = AutomaticArrayHelper
