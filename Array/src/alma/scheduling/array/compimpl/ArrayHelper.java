 ...
 * <p>
 * Name="SCHEDULING_ARRAY_1" Code="alma.scheduling.array.compimpl.ArrayHelper" Type="IDL:alma/Scheduling/Array:1.0" Container="schedulingContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class ArrayHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public ArrayHelper(Logger containerLogger)
	{
