...
cp jasperreports-3.7.4.jar $TARGET/lib/alma-8.0/;
cp jasperreports-fonts-3.7.4.jar $TARGET/lib/alma-8.0/;
...
cp jfreechart-1.0.13/lib/jfreechart-1.0.13-experimental.jar jfreechart-1.0.13/lib/jfreechart-1.0.13.jar jfreechart-1.0.13/lib/jfreechart-1.0.13-swt.jar jfreechart-1.0.13/lib/jcommon-1.0.16.jar $TARGET/lib/alma-8.0/;
...
cp $ACSROOT/lib/c3p0-0.9.1.2.jar $TARGET/lib/alma-8.0/;
cp $ACSROOT/lib/systementities.jar $TARGET/lib/alma-8.0/;
#TODO: Check for existance in INTROOT, and then in ALMASW
cp $INTROOT/lib/APDMEntities.jar $TARGET/lib/alma-8.0/;
cp $ACSROOT/lib/APDMEntities.jar $TARGET/lib/alma-8.0/;
...
rm -r $TARGET/lib/spring-2.5.5/jasperreports
...
cp ehcache-core-2.1.0/ehcache-core-2.1.0.jar $TARGET/lib/alma-8.0/;


echo "Getting jars from INTROOT..."
cp $INTROOT/lib/SchedulingPMS.jar $INTROOT/lib/SchedulingPMSCli.jar $INTROOT/lib/SchedulingCommon.jar $INTROOT/lib/SchedulingDSA.jar $TARGET/lib/alma-8.0/;



echo "Adding scripts and directories structures...";
cp -r ../create_distribution_files/getJarsFromIntroot.sh $TARGET/lib/alma-8.0/;
