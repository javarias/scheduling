...
public class TestDateTime {
	...
	public static void main(String[] args) {
		...
		try {
			...
			File outFile = new File("outDateTime.txt");
		...
		out.println("Timezone is UT.");
		
		out.println();
		out.println("Meeus, ex. 12.b, p. 89");
		DateTime d = new DateTime (1987,4,10,19,21,0.0);
		out.println("Mean sideral time at Greenwich on " + d + " is " + 
		...
		*/
		...
		out.println("Meeus, ex. 12.a, p. 88");
		d = new DateTime (1987,4,10.0);
		out.println("Mean sideral time at Greenwich on " + d + " is " + 
			d.getGreenwichMeanSiderealTime() + " hours.");		
		
		out.println();
		out.println("Meeus, p. 61-62");
		testLeap(2003);
		testLeap(2000);
		testLeap(2001);
		testLeap(2004);
		...
		out.println("The current time is " + now);
		out.println("The UT is " + now.getUT());
		out.println("The day number is " + now.getDayOfYear());
		out.println("The day of the week is " + now.getDayOfWeek());
		...
		int y = 2003; out.println("TD for " + y + " is " + DateTime.getDTDiff(y));
		y = 2000; out.println("TD for " + y + " is " + DateTime.getDTDiff(y));
		y = 2005; out.println("TD for " + y + " is " + DateTime.getDTDiff(y));
		y = 2015; out.println("TD for " + y + " is " + DateTime.getDTDiff(y));
		
		
		
		long currentSystemTime = System.currentTimeMillis();
		DateTime current  = new DateTime(currentSystemTime / 86400000.0 + 2440587.5);
		out.println("The current time, as a DateTime is " + current.toString());
		out.println("The currrent system time is " + currentSystemTime);
		long millisec = (long)((current.getJD() - 2440587.5) * 86400000.0 + 0.5);
		out.println("The number of millisec since Jan. 1 1970 " + millisec);

		DateTime t1 = DateTime.currentSystemTime();
		out.println("x " + t1.toString());
		DateTime t2 = new DateTime(System.currentTimeMillis());
		out.println("x " + t2.toString());
		out.println("t1 " + t1.getMillisec());
		out.println(" " + System.currentTimeMillis());
		
		///////////////////////////////////////////////////////////////////
		out.close();
		System.out.println("Look at outDateTime.txt for output");
