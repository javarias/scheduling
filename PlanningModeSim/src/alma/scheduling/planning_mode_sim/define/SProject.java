...
public class SProject implements ArchiveEntity {
	 ...
	 * @return The time this archive entry was created as an DateTime.
	 */
	 ...
	 * @return The time this archive entry was last updated as an DateTime.
	 */
	...
	public static void main(String[] arg) {
		...
		prj.setStartTime(new DateTime(2003,9,5,13,36,30));
		prj.setEndTime(new DateTime(2003,9,6,13,36,30));
		...
		prj.setId("0000001");
		prj.setTimeCreated(new DateTime(2003,9,5,0,0,0));
		prj.setTimeUpdated(new DateTime(2003,9,5,1,0,0));
		prj.setMemberLink();
