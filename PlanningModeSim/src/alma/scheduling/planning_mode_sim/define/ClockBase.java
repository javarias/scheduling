...
/**
 * The ClockBase class is an abstract class from which actual 
 * implementations, i.e. the ALMAClock and the ClockSimulator, 
 * are extended. 
 * 
 * @version 1.00  Aug 1, 2003
 * @author Allen Farris
 */
public abstract class ClockBase extends BasicComponent implements Clock {
	...
	/**
	 * Create a ClockBase for a simulation.
	 */
	protected ClockBase(SimulationInput data) {
		super(data);
	...
	/**
	 * Create a ClockBase that is not for a simulation.
	 */
	protected ClockBase() {
		super();
		this.longitudeInDegrees = 0.0;
	...
	/* 
	 * @see alma.scheduling.planning_mode_sim.define.Clock#setCoordiantes(double, double, int)
	 */
	...
	/* 
	 * Get the current time as a Julian Date.
	 */
