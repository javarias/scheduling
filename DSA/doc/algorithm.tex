...
Besides this criteria, that ensures some degree of weather stability during the execution
...
representative frequency in the higher bands, considering losses in transparency
in the edges of the bands as well. In the same way, SBs with representative targets
at low elevations will require better opacity. The exact form of these scoring functions
haven't been defined yet.

Besides this, it will be necessary to filter out SBs for which the {\it current}
atmospheric conditions are too bad to observe. A opacity value of 1-2 nepers is usually
regarded as too bad to observe (the exact limit is under discussion and it will most
probably be configurable). Similar criterias should be applied for the phase
stability and the wind speed. These filters haven't been implemented yet.  
