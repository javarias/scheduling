...
import alma.scheduling.Queued_Operator_to_SchedulingPOATie;
import alma.scheduling.AlmaScheduling.ALMAQueuedScheduler;
 ...
 * <p>
 * Name="QUEUED_OPERATOR_TO_SCHEDULING_1" Code="alma.scheduling.Queued_Operator_to_SchedulingImpl.Queued_Operator_to_SchedulingHelper" Type="IDL:alma/scheduling/Queued_Operator_to_Scheduling:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class Queued_Operator_to_SchedulingHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public Queued_Operator_to_SchedulingHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new ALMAQueuedScheduler();
	}
	...
	*/
	...
	{
		return Queued_Operator_to_SchedulingPOATie.class;
	}
	...
	*/
	...
	{
		return Queued_Operator_to_SchedulingOperations.class;
	}
