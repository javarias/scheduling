...
import alma.scheduling.Dynamic_Operator_to_SchedulingPOATie;
import alma.scheduling.AlmaScheduling.ALMADynamicScheduler;
 ...
 * <p>
 * Name="DYNAMIC_OPERATOR_TO_SCHEDULING_1" Code="alma.scheduling.Dynamic_Operator_to_SchedulingImpl.Dynamic_Operator_to_SchedulingHelper" Type="IDL:alma/scheduling/Dynamic_Operator_to_Scheduling:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class Dynamic_Operator_to_SchedulingHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public Dynamic_Operator_to_SchedulingHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new ALMADynamicScheduler();
	}
	...
	*/
	...
	{
		return Dynamic_Operator_to_SchedulingPOATie.class;
	}
	...
	*/
	...
	{
		return Dynamic_Operator_to_SchedulingOperations.class;
	}
