...
foldersTree = gFld("<i>Project Summary and Status</i>", "../Project.html")
  ...
  aux1 = insFld(foldersTree, gFld("QuickLook Result", "../Quicklook.html"))
    ...
    //aux2 = insFld(aux1, gFld("United States", "http://www.treeview.net/treemenu/demopics/beenthere_america.gif"))
      insDoc(aux1, gLnk("R", "SB1", "../SB1.html"))
      insDoc(aux1, gLnk("R", "SB2", "../SB1.html"))
      insDoc(aux1, gLnk("R", "SB3", "../SB1.html"))
      insDoc(aux1, gLnk("R", "SB4", "../SB1.html"))
  ...
  aux1 = insFld(foldersTree, gFld("Targets List", "../ajaxtab/DetailEB.html"))

    //aux2 = insFld(aux1, gFld("Target 1", "../SBDetail.html"))
    //  insDoc(aux2, gLnk("R", "SB1", "../Schedule.html"))
    //  insDoc(aux2, gLnk("R", "SB2", "../Schedule.html"))

    //aux2 = insFld(aux1, gFld("Target 2", "../SBDetail.html"))
    //  insDoc(aux2, gLnk("R", "SB3", "../Schedule.html"))
    //  insDoc(aux2, gLnk("R", "SB4", "../Schedule.html"))
