...
import alma.scheduling.ArchiveUpdaterPOATie;
import alma.scheduling.archiveupd.compimpl.ArchiveUpdaterImpl;
 ...
 */
public class ArchiveUpdaterHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public ArchiveUpdaterHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return ArchiveUpdaterPOATie.class;
	}
	...
	*/
	...
	{
		return ArchiveUpdaterOperations.class;
	}
