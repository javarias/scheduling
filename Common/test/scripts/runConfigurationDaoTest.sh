...
declare TEST_CLASS=alma.scheduling.datamodel.config.dao.ConfigurationDaoTest
declare TEST_LOG_FILE=tmp/ConfigurationDaoTest.log

printf "###############################################\n"
printf "ConfigurationDaoTest: "
