...
# MA 02111-1307  USA
#
# $Id: runOutputTest.sh,v 1.1 2010/02/02 20:49:50 ahoffsta Exp $
#
...
declare TEST_CLASS=alma.scheduling.output.OutputTest
declare TEST_LOG_FILE=tmp/OutputTest.log
